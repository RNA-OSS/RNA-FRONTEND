...
const initialState = {
  imagePaths: [],
  isLoadedPostLists: false,
  isLoadingPostLists: false,
  postLists: [],
  isLoadedPost: false,
  isLoadingPost: false,
  post: [],
...
export const LOAD_POST_LISTS_REQUEST = "LOAD_POST_LISTS_REQUEST";
export const LOAD_POST_LISTS_SUCCESS = "LOAD_POST_LISTS_SUCCESS";
export const LOAD_POST_LISTS_FAILURE = "LOAD_POST_LISTS_FAILURE";
...
const postReducer = (prevState = initialState, action) => {
  return produce(prevState, (draft) => {
    switch (action.type) {
      case LOAD_POST_LISTS_REQUEST:
        draft.isLoadedPostLists = false;
        draft.isLoadingPostLists = true;
        break;
